...
export function SparkleAnimation({ isHovering }: SparkleAnimationProps) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      <span className="absolute top-0 left-0 text-xl animate-ping text-white opacity-60">✦</span>
      <span className="absolute top-0 right-0 text-lg animate-ping animation-delay-100 text-white opacity-60">✦</span>
