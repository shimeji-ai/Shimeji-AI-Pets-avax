...
function sendExtensionMessage(type: string, payload?: Record<string, unknown>): Promise<unknown> {
  return new Promise((resolve, reject) => {
    ...
    function handler(event: MessageEvent) {
      ...
      if (event.data?.type === "EXTENSION_RESPONSE" && event.data?.originalType === type) {
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {isSpanish
                  ...
                  : "Manage your NFT shimejis by connecting your Ethereum wallet."}
              </p>
            </div>
          </div>
          ...
          {!mounted ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 mb-8 neural-card rounded-2xl">
              ...
              <p className="text-muted-foreground text-center mb-4 max-w-sm">
                {isSpanish
                  ? "Conecta tu wallet de Ethereum para ver tu colección de shimejis NFT."
                  : "Connect your Ethereum wallet to view your NFT shimeji collection."}
              </p>
              <WalletConnectButton />
            </div>
          ) : (
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {isSpanish
                      ...
                      : `Connected as ${address ? `${address.slice(0, 6)}...${address.slice(-4)}` : "Wallet"}`}
                  </p>
                </div>
              </div>
