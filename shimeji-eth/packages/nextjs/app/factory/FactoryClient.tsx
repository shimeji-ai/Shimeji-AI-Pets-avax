      ...
      <section className="pt-28 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-semibold text-foreground">{t("Factory", "Fábrica")}</h1>
                ...
                <div className="w-full lg:w-[280px]">
                  ...
                  {reserved ? (
                    <div className="mt-4 bg-white/5 rounded-2xl p-4 text-center border border-white/10">
                      ...
                      <p className="text-sm font-semibold text-foreground">{t("Egg reserved!", "¡Huevo reservado!")}</p>
                  ...
                  {reserveError ? <p className="mt-3 text-xs text-red-500">{reserveError}</p> : null}
                </div>
              </div>
            </div>
          ) : (
