...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. The extension is free and includes a default mascot with full AI chat. Custom shimejis are available through the auction.",
  },
  {
    question: "Do I need a wallet?",
    answer:
      "Only if you want to bid on a custom shimeji in the auction. The AI chat features work without a wallet.",
  },
];
                    ...
                    ? index === 0
                      ...
                      : index === 1
                        ...
                        : index === 4
                              ...
                              : index === 5
                                ? "Sí. La extensión es gratuita e incluye una mascota por defecto con chat IA. Los shimejis personalizados se consiguen en la subasta."
                                : "Solo si querés ofertar por un shimeji personalizado en la subasta. Las funciones de chat IA funcionan sin wallet."
                    : faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
