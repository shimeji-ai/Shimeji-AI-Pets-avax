...
const MAC_RELEASE_URL =
  "https://github.com/shimeji-ai/Shimeji-AI-Pets-avax/releases/latest/download/shimeji-desktop-macos.zip";
const CHROME_RELEASE_URL =
  "https://github.com/shimeji-ai/Shimeji-AI-Pets-avax/releases/latest/download/shimeji-chrome-extension.zip";
const FIREFOX_RELEASE_URL =
  "https://github.com/shimeji-ai/Shimeji-AI-Pets-avax/releases/latest/download/shimeji-firefox-extension.zip";
