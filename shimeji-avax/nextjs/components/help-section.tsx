...
const providers = [
  ...
  },
  {
    ...
    stepsEn: [
      ...
      "Click your Shimeji and ask anything onchain — swaps, balances, contract calls, and more.",
    ],
    stepsEs: [
      ...
      "Hacé click en tu Shimeji y preguntá lo que quieras onchain — swaps, balances, llamadas a contratos, y más.",
    ],
